...
- [StackHawk HawkScan](https://www.stackhawk.com/products/hawkscan) - Configure, run, and interpret HawkScan DAST results, generating stackhawk.yml configs and turning findings into prioritized fix tasks. *Use case: DAST scan setup, stackhawk.yml generation, security-finding remediation planning.* (Claude Code, Cowork)
